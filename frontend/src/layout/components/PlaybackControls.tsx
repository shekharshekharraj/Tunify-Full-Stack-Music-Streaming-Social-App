...
import { Laptop2, ListMusic, Mic2, Maximize2, Pause, Play, Repeat, Repeat1, Shuffle, SkipBack, SkipForward, Volume1 } from "lucide-react";
...
export const PlaybackControls = () => {
	const { currentSong, isPlaying, togglePlay, playNext, playPrevious, toggleFullScreen, showLyrics, toggleLyrics, currentTime, setCurrentTime, repeatMode, toggleRepeatMode } = usePlayerStore();
				...
				<div className='hidden sm:flex items-center gap-4 min-w-[180px] w-[30%]'>
					{currentSong && (
						<>
							...
							<Button size='icon' variant='ghost' className='hover:text-white text-zinc-400' onClick={toggleFullScreen}>
				...
				<div className='hidden sm:flex items-center gap-4 min-w-[180px] w-[30%] justify-end'>
					...
					<div className='flex items-center gap-2'>
						...
						<Slider
							...
							max={100}
							step={1}
							className='w-24 hover:cursor-grab active:cursor-grabbing custom-slider'
							onValueChange={(value) => {
								setVolume(value[0]);
								if (audioRef.current) {
